        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Niche = table.Column<string>(type: "varchar(255)", nullable: false),
                    Region = table.Column<string>(type: "varchar(255)", nullable: false),
                    ResumeFileName = table.Column<string>(type: "varchar(500)", nullable: false),
                    ResumeFilePath = table.Column<string>(type: "varchar(1000)", nullable: false),
                    EmailSubject = table.Column<string>(type: "varchar(500)", nullable: false),
